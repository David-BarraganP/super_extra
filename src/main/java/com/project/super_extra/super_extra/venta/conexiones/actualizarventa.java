...
public class actualizarventa {
    ...
    public static void Actualizar(int id_venta, // ID DE LA VENTA QUE DESEAMOS ACTUALIZAR
                                  ...
                                  int nuevoUsuario) { //NUEVO USUARIO QUE REALIZO LA VENTA
        ...
        try {
            ...
            String sql = "update venta set fecha=?, id_cliente=?, total=?, id_usuario=? where id_venta=?";
            //// ASIGNAR LOS VALORES A CADA PARÁMETRO
            declaracion = conectar.prepareStatement(sql);
            declaracion.setInt(1, id_venta);
            declaracion.setString(2, nuevaFecha);
            declaracion.setInt(3, nuevoIdCliente);
            declaracion.setInt(4, nuevoTotal);
            declaracion.setInt(5, nuevoUsuario);
    ...
    public static void main(String[] args) {
        ...
        Actualizar(12, "20/10/2025", 25, 310500,5);
