...
public class borrarventa {
    ...
    public static void BorrarVenta(int idvent) { // 1 usage
        ...
        try {
            ...
            if (eliminadas > 0) {
                System.out.println("venta de id: " + idvent + " Eliminada");
            } else {
    ...
    public static void main(String[] args) {
        BorrarVenta( 2); // Se elimina el cliente con ID = 4 de la tabla 'cliente'
    }
}
