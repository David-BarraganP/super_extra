...
public class Insertarventa {
  // Método estático que recibe los datos del cliente y los inserta en la base de datos
    ...
    public static void Insertarventa(int id_venta, // 1 usage
                                        String fecha,
                                        int id_cliente,
                                        int total,
                                        int id_usuario) {
     ...
     // Declaración de los objetos necesarios para la conexión y ejecución del SQL
        ...
        try {
            ...
            String sql = "insert into venta(id_venta, fecha, id_cliente, total,id_usuario) values(?,?,?,?)";
    ...
    public static void main(String[] args) {
        ...
        Insertarventa(12, "15/10/2025", 22, 150500, 3);
    }
}