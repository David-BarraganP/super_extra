...
public class borrarProducto {
    ...
    public static void BorrarCliente(int idproducto) { // 1 usage
        ...
        try {
            ...
            String sql = "delete from cliente where id_product = ?";

            // PREPARAR LA SENTENCIA SQL
            declaracion = conectar.prepareStatement(sql);
            declaracion.setInt(1, idproducto); // Asigna el valor del ID al parámetro de la consulta
            ...
            if (eliminadas > 0) {
                System.out.println("Persona de id: " + idproducto + " Eliminada");
            } else {
