...
public class consultarProducto {
    public static void main(String[] args) {
        ...
        try {
            ...
            String sql = "select id_producto, nombre, descripcion, color, precio_compra from producto";
            ...
            while (resultado.next()) {
                ...
                int idproductoResultado = resultado.getInt("id_producto");
                String nombreResultado = resultado.getString("nombre");
                String descripcionResultado = resultado.getString("descripcion");
                String colorResultado = resultado.getString("color");
                int precioResultado = resultado.getInt("precio_compra");

                // Se muestran los datos en consola
                System.out.println("ID_PRODUCTO: " + idproductoResultado);
                System.out.println("NOMBRE: " + nombreResultado);
                System.out.println("DESCRIPCION: " + descripcionResultado);
                System.out.println("COLOR: " + colorResultado);
                System.out.println("PRECIO_PRODUCTO: " + precioResultado);
